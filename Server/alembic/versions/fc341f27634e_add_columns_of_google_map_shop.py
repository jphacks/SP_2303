...
def upgrade() -> None:
    ...
    op.add_column('google_map_shop', sa.Column('name', sa.String(length=200), nullable=False))
    op.add_column('google_map_shop', sa.Column('address', sa.String(length=200), nullable=False))
